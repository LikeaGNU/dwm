...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { "#9b9b9b", "#000000", "#000000" },
	[SchemeSel]  = { "#ffffff", "#8c8c8c", "#ffffff" },
};
...
static const char *termcmd[] = { "tabbed", "-c", "-r", "2", "st", "-w", "\'\'", "-T", "TERMINAL", "-e", "scroll", "/bin/bash", NULL };
